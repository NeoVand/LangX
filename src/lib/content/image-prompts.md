...
### `chapter-langchain-hero` — Phase 1 banner (1600 × 900)

> A cross-section diagram of an old industrial pipe organ, mid-century editorial illustration. Tubes of varying diameters branch and merge, each carrying a different colored fluid (warm ochre prevails, with one stream of petrol blue). Brass valves are labeled with abstract symbols only. A gloved hand from the right adjusts one valve. Hand-drawn line work, paper grain, restrained palette. Negative space upper-left for chapter title.
