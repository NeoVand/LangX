<script lang="ts">
	...
	import { maskArray } from '$lib/transformer-explainer/utils/array';
...
import { theme } from '$lib/transformer-explainer/constants/theme';
	...
	import { ATTENTION_OUT } from '$lib/transformer-explainer/constants/opacity';
	import { ga } from '$lib/transformer-explainer/utils/event';
	import { ZoomInOutline } from '$lib/transformer-explainer/te-ui/icons';
	...
	import { highlightAttentionPath, removeAttentionPathHighlight } from '$lib/transformer-explainer/utils/textbook';
