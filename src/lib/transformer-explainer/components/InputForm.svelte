<script lang="ts">
	// @ts-nocheck
	import { Dropdown, DropdownItem, ButtonGroup } from '$lib/transformer-explainer/te-ui';
	import Temperature from './Temperature.svelte';

	import { ChevronDownOutline } from '$lib/transformer-explainer/te-ui/icons';
	import {
		inputText,
		isModelRunning,
		predictedToken,
	...
	import { completeCurrentAnimation } from '$lib/transformer-explainer/utils/animation';
