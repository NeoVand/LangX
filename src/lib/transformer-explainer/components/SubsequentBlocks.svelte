<script lang="ts">
	// @ts-nocheck
	import { tokens, modelMeta, isBoundingBoxActive, expandedBlock, blockIdx } from '$lib/transformer-explainer/store';
...
<style lang="scss">
	...
	.prob-dim {
		...
		background: linear-gradient(180deg, rgba(22, 19, 15, 0) 0%, rgba(22, 19, 15, 1) 100%);
