<script lang="ts">
	// @ts-nocheck
	import { Tooltip } from '$lib/transformer-explainer/te-ui';
	import { setContext, getContext, onMount } from 'svelte';
	import classNames from 'classnames';
	import { gsap, Flip } from '$lib/transformer-explainer/utils/gsap';
...
import { theme } from '$lib/transformer-explainer/constants/theme';
	...
	import { expandedBlock, predictedToken, highlightedIndex, modelData } from '$lib/transformer-explainer/store';
	import ProbabilityBars from './ProbabilityBars.svelte';
	import Katex from '$lib/transformer-explainer/utils/Katex.svelte';
	import { ga } from '$lib/transformer-explainer/utils/event';
	import { EyeOutline, ZoomInOutline } from '$lib/transformer-explainer/te-ui/icons';
	...
	import TextbookTooltip from '$lib/transformer-explainer/components/common/TextbookTooltip.svelte';
...
>
	...
	>
		...
		<div class="first-column relative flex justify-end">
			...
			<div class="vector vocab opacity-100 w-0"></div>
		</div>
			...
			{#if isSoftmaxExpanded}
				<div class="softmax-subtitle softmax-detail flex text-center text-xs opacity-0">
					...
					<div class="title-box logits">
						...
						>
							Logits <EyeOutline class="icon text-gray-400" size={20} />
						</div>
					</div>
	...
	.softmax {
		...
		.second-column {
			...
			.dim {
				...
				background: linear-gradient(180deg, rgba(22, 19, 15, 0) 0%, rgba(22, 19, 15, 1) 70%);
			}
		}
	}
</style>
