<script lang="ts">
	// @ts-nocheck
	import { tokens, modelMeta, blockIdx, attentionHeadIdx, vectorHeight } from '$lib/transformer-explainer/store';
	...
	import { onClickReadMore } from '$lib/transformer-explainer/utils/event';
