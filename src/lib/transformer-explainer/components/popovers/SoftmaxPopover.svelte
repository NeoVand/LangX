<script lang="ts">
	// @ts-nocheck
	import { Card } from '$lib/transformer-explainer/te-ui';
	import { modelData, sampling, predictedToken, temperature } from '$lib/transformer-explainer/store';
	import Katex from '$lib/transformer-explainer/utils/Katex.svelte';
	import { ArrowRightOutline } from '$lib/transformer-explainer/te-ui/icons';
