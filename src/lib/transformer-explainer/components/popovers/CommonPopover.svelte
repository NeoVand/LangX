<script lang="ts">
	...
	import { Popover } from '$lib/transformer-explainer/te-ui';
	import type { PopoverProps } from '$lib/transformer-explainer/te-ui/types';
	import { userId } from '$lib/transformer-explainer/store';
